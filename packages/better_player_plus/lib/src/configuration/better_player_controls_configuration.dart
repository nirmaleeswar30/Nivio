...
class BetterPlayerControlsConfiguration {
  const BetterPlayerControlsConfiguration({
    ...
    this.enableControlsBackdrop = false,
    this.controlsBackdropColor = const Color(0xB3000000),
    this.controlsBackdropTopHeight = 96.0,
  ...
  ///Enable top and bottom gradient backdrop while controls are visible.
  final bool enableControlsBackdrop;

  ///Base color used for the optional controls backdrop gradients.
  final Color controlsBackdropColor;

  ///Height of the top controls backdrop gradient.
  final double controlsBackdropTopHeight;

  ///Height of the bottom controls backdrop gradient.
  final double controlsBackdropBottomHeight;

  ///Inactivity timeout used to hide controls automatically.
  final Duration controlsVisibilityTimeout;
